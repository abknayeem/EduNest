  ...
  if (isError)
    return (
      <div className="text-red-500">
        Error: {error.data?.message || "Failed to load details."}
      </div>
    );
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <StatCard
          title="Status"
          value={instructor.isDisabled ? "Disabled" : "Enabled"}
        />
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <Card>
          ...
          <CardContent className="grid grid-cols-2 gap-4">
            <DetailRow
              label="Phone Number"
              value={instructor.alternativeNumber}
            />
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            {instructor.educationHistory &&
            instructor.educationHistory.length > 0 ? (
              instructor.educationHistory.map((edu, index) => (
                <div
                  key={index}
